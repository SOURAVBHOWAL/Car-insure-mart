...
async function getRegister(email) {
    ...
    if(response.ok){
        ...
        if(registered_user && !registered_user.carPic){
                 ...
                 policyItem.innerHTML = `
                     <div class="card">
                         ...
                         <h5 class="card-title" id="company${count+1}" value="${policy.companyName}">${policy.companyName}</h5>
                                ...
                                <a href="car_evaluation.html" class="btn btn-primary" id="button${count+1}" value=${count+1}>Buy Policy</a>
                         </div>
                     </div>
                 `;
                           ...
                           policyItem.innerHTML = `
                               <div class="card">
                                   <div class="card-body">
                                       ...
                                       <input type="text" class="card-text" id="deductible${count+1}" value="${policy.deductible}" readOnly><br>
                                       <label for= "idv${count+1}"><strong>IDV:</strong></label>
                                       <input type="text" class="card-text" id="idv${count+1}" value="${IDV}" readOnly><br>
                                       <label for= "premium${count+1}"><strong>Premium:</strong></label>
                                       <input type="text" class="card-text" id="premium${count+1}" value="${IDV*policy.no_of_years_covered*policy.own_damage_factor}" readOnly><br>
        ...
        else if(registered_user && registered_user.carPic){
            const zerodep=registered_user.zerodep;
            const ncb=registered_user.ncb;
            let z,n;
            if(zerodep==="Yes"){
                z=1.2;
            }
        ...
        document.getElementById('viewPolicies').addEventListener("click", async () => {
                    ...
                    policyItem.innerHTML = `
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="text" class="card-text" id="idv${count+1}" value="${IDV}" readOnly><br>
                                <label for= "premium${count+1}"><strong>Premium:</strong></label>
                                <input type="text" class="card-text" id="premium${count+1}" value="${IDV*policy.no_of_years_covered*policy.own_damage_factor*z*n}" readOnly><br>
         ...
         .catch(error => {
            ...
            document.getElementById('viewPolicies').addEventListener("click", () => {
                    fetch('http://localhost:5000/policies', {
                     method: 'GET',
                     headers: {
                         'Content-Type': 'application/json',
                         ...
                         policyItem.innerHTML = `
                             <div class="card">
                                 <div class="card-body" value=>
                                     <h5 class="card-title">${policy.companyName}</h5>
                                     <p class="card-text"><strong>Policy Type:</strong> ${policy.policyType}</p>
                                     <p class="card-text"><strong>Policy Tier:</strong> ${policy.policyTier}</p>
